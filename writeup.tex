...
\begin{figure}[h!]
    ...
    \subfloat[IGZO overetch]{
        ...
        \vphantom{\includegraphics[width=0.5\columnwidth,valign=m]{data/resistance.png}}
        \label{fig:overetch}
    }
...
\begin{figure}[htbp]
    \centering
    \subfloat[Transfer characteristics\\ ($W=30\mu$m, $L=5\mu$m)]{\includegraphics[width=0.48\columnwidth,trim=0px 0px 0px 25px,clip]{data/0502_30_5_transfer.png}\label{fig:30_5_transfer}}
    \quad
    \subfloat[Transfer characteristics\\ ($W=80\mu$m, $L=5\mu$m)]{\includegraphics[width=0.48\columnwidth,trim=0px 0px 0px 25px,clip]{data/0502_80_5_transfer.png}\label{fig:80_5_transfer}}
    \par
    \subfloat[Output characteristics\\ ($W=30\mu$m, $L=5\mu$m)]{  \includegraphics[width=0.45\columnwidth,trim=0px 0px 35px 30px,clip]{data/0502_30_5_output.png}\label{fig:30_5_output}}
    \quad
    \subfloat[Output characteristics\\ ($W=80\mu$m, $L=5\mu$m)]{  \includegraphics[width=0.45\columnwidth,trim=0px 0px 35px 30px,clip]{data/0502_80_5_output.png}\label{fig:80_5_output}}
...
%\begin{figure}[htbp]
%    \centering
%    \subfloat[Transfer characteristic in subthreshold regime\\ ($W=30\mu$m, $L=5\mu$m)]{\includegraphics[width=0.4\columnwidth,trim=0px 0px 40px 40px,clip]{data/30_5_vt_degradation.png}\label{fig:30_5_vt_degradation}}
%    \quad
%    \subfloat[Transfer characteristic in subthreshold regime\\ ($W=80\mu$m, $L=5\mu$m)]{\includegraphics[width=0.4\columnwidth,trim=0px 0px 40px 40px,clip]{data/80_5_vt_degradation.png}\label{fig:80_5_vt_degradation}}
...
\begin{figure}[htbp]
    \centering
    \subfloat[Intrinsic gain vs. bias point\\ ($W=30\mu$m, $L=5\mu$m)]{\includegraphics[width=0.48\columnwidth]{data/30_5_gmiroi.png}\label{fig:30_5_gmiroi}}
    \quad
    \subfloat[Intrinsic gain vs. bias point\\ ($W=80\mu$m, $L=5\mu$m)]{\includegraphics[width=0.48\columnwidth]{data/80_5_gmiroi.png}\label{fig:30_5_gmiroi}}
...
\begin{figure}[htbp]
    \centering
    \subfloat[Original small signal model]{\includegraphics[width=0.48\columnwidth,trim=0px 20px 30px 46px,clip]{data/complete_small_signal_results_1xCpad.png}\label{fig:smallsignal_1xCpad}}
    \quad
    \subfloat[$C_L$ increased by 60x]{\includegraphics[width=0.48\columnwidth,trim=0px 20px 30px 46px,clip]{data/complete_small_signal_results_70xCpad.png}\label{fig:smallsignal_70xCpad}}
